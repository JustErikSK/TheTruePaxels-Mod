...
public class ModItems {
    ...
    public static final Item COPPER_PAXEL = registerPaxel("copper_paxel", ModToolMaterial.COPPER, 1, -2.8f, TheTruePaxelsConfig.copperDurability, false);
        ...
        settings.component(
                ...
                new ToolComponent(
                        List.of(
                                ...
                                ToolComponent.Rule.ofAlwaysDropping(blockLookup.getOrThrow(BlockTags.PICKAXE_MINEABLE), material.speed()),
                                ToolComponent.Rule.ofAlwaysDropping(blockLookup.getOrThrow(BlockTags.AXE_MINEABLE), material.speed()),
                                ToolComponent.Rule.ofAlwaysDropping(blockLookup.getOrThrow(BlockTags.SHOVEL_MINEABLE), material.speed()),
                                ToolComponent.Rule.ofAlwaysDropping(blockLookup.getOrThrow(BlockTags.HOE_MINEABLE), material.speed())
                        ),
                        1.0F,
                        1,
                        true
